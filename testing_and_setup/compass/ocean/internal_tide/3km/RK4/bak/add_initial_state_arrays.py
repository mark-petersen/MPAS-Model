...
# for some reason this didn't work:
    ...
    print(' time initialization     : %f'%((time.time()-time1)))
    ...
    print(' time init column vars   : %f'%((time.time()-time1)))
